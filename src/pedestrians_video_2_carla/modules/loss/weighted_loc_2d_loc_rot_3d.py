...
def calculate_loss_weighted_loc_2d_loc_rot_3d(requirements: Dict[str, Tensor], loss_weights: Dict[str, Tensor], **kwargs) -> Tensor:
    """
    Calculates the weighted sum of the 'common_loc_2d', 'loc_3d' and 'rot_3d' losses.
    ...
    :param loss_weights: The dictionary containing the weights for 'common_loc_2d', 'loc_3d', and 'rot_3d'.
    :type requirements: Dict[str, Tensor]
    :return: The weighted sum of the 'common_loc_2d', 'loc_3d', and 'rot_3d' losses.
    :rtype: Tensor
    """
    try:
        loss = torch.tensor(loss_weights.get('common_loc_2d', 1.0), device=requirements['common_loc_2d'].device) * requirements['common_loc_2d'] + \
