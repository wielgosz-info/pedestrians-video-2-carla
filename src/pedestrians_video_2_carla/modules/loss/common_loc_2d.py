...
def calculate_loss_common_loc_2d(criterion: loss._Loss, input_nodes: Type[Skeleton], inputs: Tensor, projection_2d: Tensor = None, projection_2d_transformed: Tensor = None, **kwargs) -> Tensor:
    """
