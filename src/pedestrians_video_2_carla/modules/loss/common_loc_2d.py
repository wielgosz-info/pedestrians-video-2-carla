...
def calculate_loss_common_loc_2d(criterion: loss._Loss, input_nodes: Type[Skeleton], projection_2d_transformed: Tensor, inputs: Tensor, **kwargs) -> Tensor:
    """
    ...
    :param projection_2d_transformed: Normalized projection as calculated by the projection module.
